...
<reference>
@/Users/russdean/Projects/splitzkrieg/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/russdean/Projects/splitzkrieg/.claude/get-shit-done/references/user-profiling.md` to load:
