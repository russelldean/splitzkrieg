...
Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/russdean/Projects/splitzkrieg/.claude/get-shit-done
                  → writes to /Users/russdean/Projects/splitzkrieg/.claude/get-shit-done/hooks/
...
```bash
INIT=$(node "/Users/russdean/Projects/splitzkrieg/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/russdean/Projects/splitzkrieg/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/russdean/Projects/splitzkrieg/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
