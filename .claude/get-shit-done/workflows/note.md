...
- **Global scope**: `/Users/russdean/Projects/splitzkrieg/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/russdean/Projects/splitzkrieg/.claude/notes/`)
...
2. Glob `/Users/russdean/Projects/splitzkrieg/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/russdean/Projects/splitzkrieg/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/russdean/Projects/splitzkrieg/.claude/notes/` — works in any directory
