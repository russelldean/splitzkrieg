...
- Usage: Reference from command with `@/Users/russdean/Projects/splitzkrieg/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/russdean/Projects/splitzkrieg/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/russdean/Projects/splitzkrieg/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
