#!/usr/bin/env node
/**
 * One-time: create Jenna Land, who first appears in the S36 week 4 (8/24, Event C)
 * lineup submission for Sparadigm Shift, and relink her lineupEntries row from
 ...
 *
 * Usage:
 *   node scripts/add-s36-w4-jenna-land.mjs                  # DRY RUN
 *   node scripts/add-s36-w4-jenna-land.mjs --commit [--gender=F]
 */
...
const B = { name: 'Jenna Land', slug: 'jenna-land', submittedAs: 'Jenna Land' };
