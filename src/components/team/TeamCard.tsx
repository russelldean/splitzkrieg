...
export function TeamCard({ team }: Props) {
  ...
  return (
    ...
    >
      ...
      {isGhost ? (
        <div className="flex flex-wrap gap-x-4 gap-y-1 text-sm font-body text-navy/65 italic">
          {'👻 👻 👻'}
        </div>
      ) : (
