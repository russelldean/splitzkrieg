...
export function MiniStandings({ standings, seasonSlug, romanNumeral }: Props) {
  ...
  return (
    <div className="bg-amber-50/30 rounded-xl border border-amber-200/60 shadow-sm h-full flex flex-col overflow-hidden">
      <div className="flex items-baseline justify-between px-6 py-3 bg-amber-50 border-b border-amber-200/60">
