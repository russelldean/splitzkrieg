    ...
    <footer>
      ...
      <div className="bg-navy">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
          <nav className="flex flex-row flex-wrap items-center justify-center gap-x-6 gap-y-3">
            {secondaryLinks.map((link) => (
              <Link
                key={link.href}
                href={link.href}
                className="flex items-center gap-2 text-sm font-body font-semibold tracking-wide uppercase text-cream/70 hover:text-cream transition-colors"
              >
      ...
      {/* Branding - light */}
      <div className="bg-cream-dark border-t border-navy/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col items-center gap-5">
            <div className="grid grid-cols-3 items-center justify-items-center gap-6 sm:gap-16 max-w-2xl w-full mx-auto">
              <Image
              ...
              <Link href="/bowler/matt-tauch" title="Logo by Matt Tauch">
                <Image
                  ...
                  width={200}
                  height={72}
                  className="h-16 sm:h-20 w-auto mix-blend-multiply opacity-85 hover:opacity-100 transition-opacity"
                />
              </Link>
              <Link href="/bowler/matt-tauch" title="Logo by Matt Tauch">
                <Image
                  ...
                  width={160}
                  height={141}
                  className="h-16 sm:h-20 w-auto mix-blend-multiply opacity-75 hover:opacity-100 transition-opacity"
                />
              </Link>
            </div>
            <p className="font-body text-navy/50 text-sm tracking-wide">
