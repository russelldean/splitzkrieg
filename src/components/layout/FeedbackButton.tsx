  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-5 right-5 z-40 bg-navy text-cream rounded-full px-4 py-2.5 text-sm font-body font-medium shadow-lg hover:bg-navy-light transition-colors flex items-center gap-2"
