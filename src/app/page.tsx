  ...
  return (
    <div className="min-h-screen bg-cream">
      ...
      <section className="relative">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 -mt-2 sm:-mt-1 pb-2 sm:pb-4">
      ...
      {/* Content Grid */}
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-3 sm:pt-6 pb-4 sm:pb-6">
