/**
 * Individual Champions page.
 * Scratch and handicap individual championship history.
 */
import Link from 'next/link';
import type { Metadata } from 'next';
import { getAllIndividualChampions } from '@/lib/queries';
...
export default async function IndividualChampionsPage() {
  const champions = await getAllIndividualChampions();
  ...
  return (
    <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-12">
      <div className="flex items-center gap-2 text-sm font-body text-navy/65 mb-4">
        ...
        <span className="text-navy/60">/</span>
        <span className="text-navy/70">Individual Champions</span>
      </div>
      ...
      <p className="font-body text-lg text-navy/60 mt-1">
        Scratch and handicap champions across all seasons
      </p>

      <div className="mt-8">
        <IndividualChampionsTable champions={champions} />
      </div>
