  ...
  return (
    ...
    <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="space-y-8">
        {/* League Rules */}
        <section className="bg-white rounded-xl border border-navy/10 shadow-sm px-8 py-8">
        ...
        <section className="bg-white rounded-xl border border-navy/10 shadow-sm px-8 py-8 shadow-sm">
