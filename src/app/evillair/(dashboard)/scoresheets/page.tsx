...
export default function ScoresheetsPage() {
  ...
  const loadPreview = useCallback(async () => {
    ...
    try {
      const res = await fetch('/api/evillair/scoresheets/preview', {
        method: 'POST',
  ...
  const handleEmail = useCallback(async () => {
    ...
    try {
      ...
      const res = await fetch('/api/evillair/scoresheets/email', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const handleGenerate = useCallback(async () => {
    ...
    try {
      const res = await fetch('/api/evillair/scoresheets', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ seasonID, week, source }),
      });
