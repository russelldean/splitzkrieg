...
export default function AdminDashboardPage() {
  ...
  const handleRemind = useCallback(async () => {
    ...
    try {
      const res = await fetch('/api/evillair/remind-captains', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
  ...
  const handlePublish = useCallback(async () => {
    ...
    try {
      const res = await fetch('/api/evillair/publish', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const handleEmail = useCallback(async () => {
    ...
    try {
      const res = await fetch('/api/evillair/email', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ seasonID: data.season.seasonID, week }),
      });
...
function EasterEggs() {
  ...
  useEffect(() => {
    fetch('/api/evillair/new-blog-badge')
      .then(r => r.json())
