...
export default function ScoresPage() {
  ...
  const handlePull = useCallback(async () => {
    ...
    try {
      const res = await fetch('/api/evillair/scores/pull', {
        method: 'POST',
  ...
  const handleManualEntry = useCallback(async () => {
    ...
    try {
      const res = await fetch('/api/evillair/scores/manual', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const handleConfirm = useCallback(async () => {
    ...
    try {
      ...
      const res = await fetch('/api/evillair/scores/confirm', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
