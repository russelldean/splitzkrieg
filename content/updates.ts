...
const updates: Update[] = [
  ...
  { date: '2026-03-13', text: 'Collapsible season accordion on weeks page', tag: 'feat', href: '/weeks' },
  { date: '2026-03-13', text: 'League Timeline sorted by team debut order', tag: 'feat', href: '/teams' },
  { date: '2026-03-12', text: 'W-L-T record now shows on team cards', tag: 'feat', href: '/teams' },
  ...
  { date: '2026-03-11', text: 'Site Updates feed on the Resources page', tag: 'feat', href: '/resources#recent-updates' },
  { date: '2026-03-11', text: 'Blog page and featured post card', tag: 'feat', href: '/blog' },
